...
| ENG-7 | CI records compile, unit tests, platform runs and GPU runs separately | `.github/workflows/ci.yml` (Linux and Windows × Python 3.11–3.13, pure-Python-kernel job) | runs 36130441504 (0.1.0) and 36151891410 (0.2.0): all 7 jobs success | partial: no GPU job (no CUDA code) |
